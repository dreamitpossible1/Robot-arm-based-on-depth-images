...
This project develops a robot-arm system for the Qualcomm RB3 Gen2 platform that relies on depth images to perceive and manipulate objects in 3-D space. The RB3 Gen2 serves as the core hardware platform, providing advanced computing capabilities. Depth images—whose depth values are generated by the MiDaS-v2 monocular depth-estimation network—enable the robot arm to reconstruct 3-D scenes in real time for tasks such as object recognition and grasping. The Qualcomm Intelligent Robotics Product SDK handles the subsequent image processing and provides seamless integration with the RB3 Gen2, further enhancing overall system performance and reliability.

 <p align="center"> <img src="https://github.com/dreamitpossible1/Robot-arm-based-on-depth-images/blob/main/Scipts_RB3/Technical%20Flowchart.png" />
...
2. Press and hold the **F\_DL** button
   <p align="center"> <img src="https://github.com/user-attachments/assets/edad3a81-028d-4929-a623-2e8469f661d5" alt="F_DL Button and USB Type-C port" /> </p> 
   <p align="center"><i>Figure 2: Location of the USB Type-C port and F_DL button</i></p>
